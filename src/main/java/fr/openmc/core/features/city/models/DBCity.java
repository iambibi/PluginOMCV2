...
public class DBCity {
    ...
    public DBCity(String uuid, String name, double balance, String type, int power, int freeClaims, int level) {
        this.UUID = uuid;
        this.name = name;
    ...
    public City deserialize() {
        return new City(UUID, name, balance, type, power, freeClaims, level);
    }
}
